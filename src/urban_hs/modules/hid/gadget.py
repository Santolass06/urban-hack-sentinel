...
class USBGadgetManager:
    ...
    def __init__(self, config: GadgetConfig | None = None):
    ...
    def create_gadget(self, config: GadgetConfig | None = None) -> bool:
    ...
    def add_hid_function(self, config: HIDConfig | None = None, instance: int = 0) -> bool:
    ...
    def add_serial_function(self, config: SerialConfig | None = None, instance: int = 0) -> bool:
    ...
    def bind_udc(self, udc: str | None = None) -> bool:
    ...
    # Quick setup methods
    def setup_hid_keyboard(self, report_desc: bytes | None = None) -> bool:
